...
class WorkFlowStatePost(WorkFlow):
    ...
    def updateStateMsg_nav(self, state, result, x=None, y=None, theta=None):
        # print("in navigate comes, state:",state, ",   result:", result)
        ...
        # print("but...., state:",self.json_message['a_navigate']['value']['state']['value'], ",   result:",self.json_message['a_navigate']['value']['result']['value'])
