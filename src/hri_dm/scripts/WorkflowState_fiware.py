...
class WorkFlowStatePost(WorkFlow):
    ...
    def updateStateMsg_grasp(self, toolID, x, y, z, state, result):
    ...
    def updateStateMsg_release(self, toolID, fingerState, armState, result):
        self.json_message['a_releaseTool']['value']['toolID']['value'] = toolID
        # self.json_message['a_releaseTool']['value']['fingerState']['value'] = fingerState
        # self.json_message['a_releaseTool']['value']['armState']['value'] = armState
        if result is True:
